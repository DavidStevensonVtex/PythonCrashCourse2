...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Create an instance of st ore game statistics,
    ...
    def _ship_hit(self):
        ...
        print(f"self.stats.ships_left: {self.stats.ships_left}")
    ...
    def _create_fleet(self):
        ...
        available_space_x = full_size_screen_width - (2 * alien_width)
        number_aliens_x = available_space_x // ( 2 * alien_width )

        # Determine the number of rows of aliens that fit on the screen
        ship_height = self.ship.rect.height
        available_space_y = full_size_screen_height - ( 3 * alien_height ) - ship_height
